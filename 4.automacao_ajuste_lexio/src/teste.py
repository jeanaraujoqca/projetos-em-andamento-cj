...
class ProdutividadeLexio:
    ...
    def alterar_produtividade(self):
        ...
        produtividade = self.wait.until(EC.element_to_be_clickable((By.XPATH, "//div[@class='basBURnp9_MxdYpbhW_9__contrato']//a//span[text()='Produtividade de Lays Giselle de 01.06 até 30.06']")))
        produtividade.click()
        sleep(1)
    ...
    def digitar_valores(self, dataframe):
        while self.lista_nomes_ufs:
            ...
            elemento_valor_bruto = self.driver.find_element(By.XPATH, f'//*[@id="workflowAdmin"]/div/div[1]/div/div[2]/div[1]/div[2]/div/div[3]/path[@value = "{uf}"]')
    ...
    def anexar_documento(self, documento_para_anexar):
        ...
        self.anexo = WebDriverWait(self.driver, 10).until(EC.element_to_be_clickable((By.XPATH, '//*[@id="workflowAdmin"]/div/div[1]/div/div[1]/div[2]/button[4]')))
        self.anexo.click()
        sleep(1.5)
        
        # Enviamos o diretorio do arquivo correspondente para ser salvo dentro do sistema
        self.arquivo = self.driver.find_element(By.XPATH, '//*[@id="dialog-add-attachment-file"]')
